...
| --- | --- | --- | --- | --- | --- |
| Pokémon X | Japan | 7 selectable languages | Base / 1.0 | Reference only | Official JP product/language pages reviewed; no retail hashes available. |
| Pokémon X | Japan | 7 selectable languages | Ver.1.5 | Reference only | Nintendo Japan currently records distribution on 2015-04-23; binary identity not locally verified. |
| Pokémon X | Japan | 7 selectable languages | Ver.1.1–1.4 | Unverified | Historical public-source recovery and per-update provenance audit in progress. |
| Pokémon X | Other markets | TBD | Base + applicable updates | Unverified | Region/SKU census pending; do not infer region from language selector alone. |
...
- [ ] Recover and register all X update-history sources (1.1–1.5) by market.
...
1. Finish the Japan-market X version/update baseline from official and preserved official sources.
