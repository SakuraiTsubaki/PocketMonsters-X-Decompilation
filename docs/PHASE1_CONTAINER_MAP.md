...
For each verified target, preserve only metadata and reconstructed analysis in Git:

- source identity manifest
- extracted-tree identity manifest
- ExeFS file list and hashes
- RomFS file list and hashes
- pairwise comparison report
- notes identifying which paths are unchanged, changed, added, or removed
