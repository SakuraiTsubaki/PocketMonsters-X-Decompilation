...
class WorkstreamRegistryTests(unittest.TestCase):
    def test_valid_registry(self) -> None:
        registry = {
            "schema": "generation-vi.workstreams.v1",
            "titles": ["X", "Y", "OmegaRuby", "AlphaSapphire"],
            "workstreams": [
                {"id": "common", "titles": ["X", "Y", "OmegaRuby", "AlphaSapphire"], "status": "opened", "evidence": "direct evidence"},
                {"id": "xy", "titles": ["X", "Y"], "status": "mapping", "evidence": "paired evidence"},
            ],
        }
    ...
    def test_duplicate_and_bad_scope_are_rejected(self) -> None:
        registry = {
            ...
            "titles": ["X", "Y", "OmegaRuby", "AlphaSapphire"],
            "workstreams": [
                {"id": "dup", "titles": ["X"], "status": "opened", "evidence": "a"},
                {"id": "dup", "titles": ["Invalid"], "status": "unknown", "evidence": ""},
            ],
        }
