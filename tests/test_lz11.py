...
class LZ11Tests(unittest.TestCase):
    ...
    def test_short_back_reference(self):
        # A, B, C, then copy 3 bytes from distance 3 => ABCABC.
    ...
    def test_medium_length_form(self):
        # Literal A, then indicator 0 encodes length 0x11 at distance 1.
    ...
    def test_long_length_form(self):
        # Literal A, then indicator 1 encodes length 0x111 at distance 1.
        size = 1 + 0x111
        encoded = bytes(
