...
class CompareManifestTests(unittest.TestCase):
    def test_compare_categories(self) -> None:
        left = {"entries": [
            {"path": "exefs/code.bin", "size": 4, "sha256": "same"},
            {"path": "romfs/a.bin", "size": 1, "sha256": "left"},
            {"path": "romfs/left.bin", "size": 1, "sha256": "only-left"},
        ]}
        right = {"entries": [
            {"path": "exefs/code.bin", "size": 4, "sha256": "same"},
            {"path": "romfs/a.bin", "size": 2, "sha256": "right"},
            {"path": "romfs/right.bin", "size": 1, "sha256": "only-right"},
        ]}
