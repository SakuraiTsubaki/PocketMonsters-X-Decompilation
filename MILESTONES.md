# Milestones: Pocket Monsters X

This roadmap governs research, tooling, analysis, reconstruction, and preservation for `SakuraiTsubaki/PocketMonsters-X-Decompilation`.
...
Coordinate format findings with Y and separate shared Generation VI structures from title-specific data.
